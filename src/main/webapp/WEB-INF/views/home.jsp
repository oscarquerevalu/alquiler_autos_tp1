...
<link href="<c:url value="/resources/css/other2.css" />" rel="stylesheet">
...
<body>
	...
	<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="?lang=en"><img alt="English" src="<spring:url value="/resources/images/eua.jpg" />"></a> 
					<a class="navbar-brand" href="?lang=es_PE"><img alt="Español" src="<spring:url value="/resources/images/peru.jpeg" />"></a> 
					<a class="navbar-brand" href="?lang=pt_BR"><img alt="Portugues" src="<spring:url value="/resources/images/brasil.jpeg" />"></a>
				</div>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		  ...
		  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
		      ...
		      <li class="nav-item">
		        <a class="nav-link disabled" href="#">Reserva</a>
		      </li>
		      <li class="nav-item">
		      ...
		      <li class="nav-item">
		        ...
		        <a class="nav-link disabled" href="${edit_url}">Cliente</a>
		      </li>		      
		    </ul>
            ...
            <div class="row">
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
					<div class="team-block">
						<div class="team-img">
							<img onclick="autoFindbyId(1);" src="<spring:url value="/resources/css/images//elantra.jpg" />" alt="Avatar" class="image">
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
					<div class="team-block">
						<div class="team-img">
							<img onclick="autoFindbyId(2);" src="<spring:url value="/resources/css/images//toyota-hilux.jpg" />" alt="Avatar" class="image">
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
					<div class="team-block">
						<div class="team-img">
							<img onclick="autoFindbyId(3);" src="<spring:url value="/resources/css/images//kia-optima-2.jpg" />" alt="Avatar" class="image">
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
					<div class="team-block">
						<div class="team-img">
							<img onclick="autoFindbyId(4);" src="<spring:url value="/resources/css/images//kia-rio-2.jpg" />" alt="Avatar" class="image">
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
					<div class="team-block">
						<div class="team-img">
							<img onclick="autoFindbyId(5);" src="<spring:url value="/resources/css/images//mercedes-1.jpg" />" alt="Avatar" class="image">
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
					<div class="team-block">
						<div class="team-img">
							<img onclick="autoFindbyId(5);" src="<spring:url value="/resources/css/images//rav4-1.jpg" />" alt="Avatar" class="image">
						</div>
					</div>
				</div>
					...
					<!-- Imagenes de auto -->
					  ...
					  <div class="carousel-inner">
					    <div class="carousel-item active">
					      <img class="d-block w-100" src="" alt="First slide" id="imgOne">
					    </div>
					    <div class="carousel-item">
					      <img class="d-block w-100" src="" alt="Second slide" id="imgTwo">
					    </div>
					    <div class="carousel-item">
					      <img class="d-block w-100" src="" alt="Third slide" id="imgThree">
					    </div>
					  </div>
