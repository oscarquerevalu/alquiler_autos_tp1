...
<link href="<spring:url value="/resources/css/bootstrap.min.css" />"
	rel="stylesheet">
<link href="<spring:url value="/resources/css/AdminLTE.css" />"
	rel="stylesheet">
...
<body class="hold-transition register-page">
	<div class="register-box">
		...
		<div class="register-box-body">
			...
			<p class="login-box-msg hide_ndv">Register a new membership</p>

			<c:url var="post_url" value="/user/create/save" />

			<form:form id="form-create" action="${post_url}"
				modelAttribute="userInfo" method="post" class="form-signin">
				...
				<div class="form-group has-feedback read_ndv">
				...
				<div class="form-group has-feedback read_ndv">
					...
					<form:input path="username" class="form-control"
						placeholder="${usernameLabel}" required="true"
						onblur="checkUsernameExist(this.value)" />
				...
				<div class="form-group has-feedback">
					...
					<form:input path="birthdate" readonly="readonly"
						id="birthdate-input" class="form-control"
						placeholder="${birthdateLabel}" required="true" />
					<span class="glyphicon glyphicon-gift form-control-feedback"></span>
				</div>

				<div class="form-group has-feedback">
					<form:errors path="telefono" element="div"
						class="alert alert-warning" />
					<spring:message code="create.input.telefono" var="telefonoLabel" />
					<form:input path="telefono" class="form-control"
						placeholder="${telefonoLabel}" required="true" />
					<span class="glyphicon glyphicon-phone form-control-feedback"></span>
				</div>

				<div class="form-group has-feedback read_ndv">
					<div id="email-alert" style="display: none;"
						class="alert alert-warning"></div>
					...
					<form:input type="email" path="email" class="form-control"
						id="email" placeholder="${emailLabel}" required="true"
						onblur="checkEmailExist(this.value)" />
					<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
				</div>

				<div class="form-group has-feedback">
					<form:errors path="direccion" element="div"
						class="alert alert-warning" />
					<spring:message code="create.input.direccion" var="direccionLabel" />
					<form:input path="direccion" class="form-control"
						placeholder="${direccionLabel}" required="true" />
				...
				<div class="form-group has-feedback">
					...
					<input type="password" id="confirm-password"
						onblur="checkPasswords()" name="confirmarSenha"
				...
				<div class="hide_ndv">
					...
					<c:forEach items="<%=Role.values()%>" var="role">
						...
						<form:radiobutton path="role" value="${role}" label="${label}"
							required="true" />&nbsp
				</c:forEach>
				</div>
								...
								success : function(data) {
									...
									if (data === 'true') {
										...
										$("#email-alert")
												.show()
												.html(
														"<spring:message code='create.message.emailExistente.parte1'/><strong> "
																+ email
																+ " </strong><spring:message code='create.message.emailExistente.parte2'/>");
									} else {
										$(":submit").removeAttr("disabled");
