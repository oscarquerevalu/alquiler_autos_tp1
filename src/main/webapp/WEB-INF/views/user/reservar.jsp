...
<html lang="es-pe">
    ...
    <body>
    	<div class="container">
			...
			<form:form id="form-create" action="${post_url}" modelAttribute="reserva" method="post" class="form-signin">
				<h2 class="form-signin-heading"><spring:message code="reserva.title"/></h2>
